...
param_alpha = 0.125 #regularization coefficient for actor_network #tested value: 0.02
...
actor_net = actor_distribution_network.ActorDistributionNetwork(   
                                         ...
                                         seed=2, #seed used for Keras kernal initializers for NormalProjectionNetwork.
...
max_reward = -1000.0
tolerence = 50 #If the eval_results does not improve within tolerence*eval_intv, then stop training.
...
plt.savefig("example1-neglog.eps",bbox_inches='tight')
...
ax[0].legend(loc='lower right',fontsize=13.5)
...
#ax[1].set_xlim(-3,85)
plt.savefig("example1-neg.svg",transparent=True,bbox_inches='tight')
plt.show()
