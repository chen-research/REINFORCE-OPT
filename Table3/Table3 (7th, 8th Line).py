...
cem_init_population = r.uniform(low=-1.0, high=1.0, size=(pop_size,6))
...
################ - 7th Line in Table 3
print("mse(m1,final_x):", mse([-0.5]*6, final_solution))
print("mse(m2,best_x):", mse([0.5]*6, final_solution))
print("best_fitness:",  final_fitness)
print(final_param)
...
r = np.random.RandomState(0)
pop_size = 600 #number of individuals in a generation
cem_init_population = r.uniform(low=0.0, high=1.0, size=(pop_size,6))
